...
public class PerceptronClassifyNoLearn extends NeuralNetwork {
    ...
    public static void main(String[] args) {
        ...
        trainingSet.addRow(new DataSetRow(new double[]{2, 0.5},new double[]{Double.NaN,Double.NaN}));
        trainingSet.addRow(new DataSetRow(new double[]{0.1, -1},new double[]{Double.NaN,Double.NaN}));
        trainingSet.addRow(new DataSetRow(new double[]{2, -1},new double[]{Double.NaN,Double.NaN}));
        trainingSet.addRow(new DataSetRow(new double[]{-1, 2},new double[]{Double.NaN,Double.NaN}));
        trainingSet.addRow(new DataSetRow(new double[]{-2, 1},new double[]{Double.NaN,Double.NaN}));
        trainingSet.addRow(new DataSetRow(new double[]{-1, -0.1},new double[]{Double.NaN,Double.NaN}));
